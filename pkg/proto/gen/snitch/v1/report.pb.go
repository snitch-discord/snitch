...
type ListReportsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ReporterId    *int32                 `protobuf:"varint,1,opt,name=reporter_id,json=reporterId,proto3,oneof" json:"reporter_id,omitempty"`
	ReportedId    *int32                 `protobuf:"varint,2,opt,name=reported_id,json=reportedId,proto3,oneof" json:"reported_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListReportsRequest) GetReporterId() int32 {
...
func (x *ListReportsRequest) GetReportedId() int32 {
...
func (x *DeleteReportRequest) GetReportId() int32 {
	if x != nil {
		return x.ReportId
	}
	return 0
...
func (x *DeleteReportResponse) GetReportId() int32 {
	if x != nil {
		return x.ReportId
	}
	return 0
...
var file_snitch_v1_report_proto_rawDesc = string([]byte{
	...
	0x05, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x22, 0x80, 0x01, 0x0a, 0x12,
	...
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x0a, 0x72, 0x65, 0x70, 0x6f, 0x72,
	0x74, 0x65, 0x72, 0x49, 0x64, 0x88, 0x01, 0x01, 0x12, 0x24, 0x0a, 0x0b, 0x72, 0x65, 0x70, 0x6f,
	0x72, 0x74, 0x65, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52,
	...
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x72,
	...
	0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
